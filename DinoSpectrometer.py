...
class DinoSpectrometer(object):
   ...
   def initialize(object):
    ...
    initialize("/home/pi/pi0/Libs/libCrystalBase_RPi.so")
    object.pSpecCore      = initialize_core_api("/home/pi/pi0/Libs/libCrystalCore_RPi.so")
    object.pSpecDevice    = initialize_device_api("/home/pi/pi0/Libs/libCrystalPort_RPi.so")
   ...
   def captureSpectrum(object):
	 ...
	 create_core_object(object.pSpecCore)
         csInit_Return = load_sensor_file(object.pSpecCore, b"/home/pi/pi0/config/sensor_" + sensorID + b".dat")
         if(csInit_Return > 0):
